...
function getSafeSelectedProvider(selectedProvider: Provider | null | undefined, isDemo?: boolean) {
          ...
          <div>
            ...
            {isDemo ? (
              ...
              <div className="card" style={{ textAlign: 'center', padding: '20px 16px' }}>
                ...
                >
                  Real nearby providers will appear here once your live provider data is connected.
                </div>
              </div>
            )}
          </div>
...
export const FindProviderScreen: React.FC = () => {
  ...
  const filtered =
    filter === 'available' ? PROVIDERS.filter((p) => p.available) : PROVIDERS;
      ...
      <div className="screen">
        <div className="screen-content">
          {!isDemo && (
            ...
            >
              <div style={{ fontFamily: 'var(--font-head)', fontWeight: 800, fontSize: 14 }}>
                Demo provider data hidden for real accounts
              </div>
              <div style={{ fontSize: 12, marginTop: 4, lineHeight: 1.5 }}>
                This screen is still using placeholder provider listings. Connect live provider data next.
              </div>
            </div>
          )}
            ...
            <>
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: i === 0 ? 34 : 26,
                        borderRadius: '50%',
                        background: i === 0 ? 'var(--teal)' : 'var(--navy)',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
              ...
              <div className="chip-scroll">
                {([
                  ...
                  <button
                    key={id}
                    className={`chip ${filter === id ? 'active' : 'inactive'}`}
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ display: 'flex', gap: 6, marginTop: 6, flexWrap: 'wrap' }}>
                      ...
                      {!p.available && (
                        <span className="badge badge-gray" style={{ fontSize: 10, padding: '2px 7px' }}>
                          Busy
                        </span>
                      )}
                    </div>
        ...
        <div className="screen">
          <div className="screen-content">
            <div className="empty-state">
              ...
              <button className="btn btn-primary" onClick={() => navigate('find-provider')}>
                Find a Provider
              </button>
            </div>
          </div>
      ...
      <div className="screen">
        <div className="map-bg" style={{ height: 220, margin: '16px', borderRadius: 'var(--radius-md)', flexShrink: 0 }}>
          <svg width="100%" height="100%" style={{ position: 'absolute', inset: 0 }}>
            <polyline
              points="60,180 110,130 170,90 220,60"
              stroke="var(--teal)"
              strokeWidth="3"
              strokeDasharray="7,5"
              fill="none"
          ...
          >
            <span style={{ fontFamily: 'var(--font-head)', fontWeight: 800, color: 'white', fontSize: 14 }}>
              {p.initials}
            </span>
          </div>
        ...
        <div className="screen-content" style={{ paddingTop: 0 }}>
                  ...
                  <div className="step-item">
                    ...
                    <span
                      style={{
                        flex: 1,
                        fontFamily: 'var(--font-head)',
                        fontWeight: s.state !== 'idle' ? 700 : 500,
                        fontSize: 14,
                        color: s.state !== 'idle' ? 'var(--text-primary)' : 'var(--text-muted)',
                      }}
                    >
                      {s.label}
                    </span>
          ...
          <button
            ...
            className="btn btn-danger btn-full panic-pulse d2 animate-in"
            style={{ fontSize: 16, padding: '18px', gap: 10 }}
          >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
            {[
              ...
              >
                ...
                <span style={{ fontFamily: 'var(--font-head)', fontWeight: 700, fontSize: 13, color: 'var(--text-secondary)' }}>
                  {a.label}
                </span>
              </button>
            ))}
          ...
          >
            ...
            <div>
              <div style={{ fontFamily: 'var(--font-head)', fontWeight: 900, fontSize: 17 }}>
                Your FIXA provider has arrived.
              </div>
              <div style={{ fontSize: 14, color: 'var(--text-secondary)', marginTop: 3 }}>
                You can verify their profile before starting the job.
              </div>
            </div>
          </div>
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div
                    style={{
                      ...
                      height: 26,
                      borderRadius: '50%',
                      background: row.done ? 'var(--green)' : 'var(--border)',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      flexShrink: 0,
                  ...
                  <span
                    style={{
                      ...
                      fontSize: 14,
                      color: row.done ? 'var(--text-primary)' : 'var(--text-muted)',
                    }}
                  >
                    {row.label}
                  </span>
            ...
            >
              <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <span
                    className={`badge ${b.status === 'Completed' ? 'badge-green' : 'badge-teal'}`}
                    style={{ marginTop: 4, display: 'block', textAlign: 'center' }}
                  >
                    {b.status}
                  </span>
                </div>
        ...
        <div className="screen-content">
          ...
          >
            ...
            <button
              ...
              style={{ fontFamily: 'var(--font-head)', fontWeight: 900, fontSize: 18, padding: '20px 56px' }}
            >
              🚨 PANIC
            </button>
          ...
          {[
            ...
            <div key={i} className="card animate-in" style={{ animationDelay: `${i * 0.04}s`, display: 'flex', gap: 14 }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-head)', fontWeight: 800, fontSize: 15, marginBottom: 4 }}>
                  {f.title}
                </div>
          ...
          <div className="card">
            ...
            <div className="form-group" style={{ marginBottom: 12 }}>
              ...
              <input
                ...
                defaultValue={isDemo ? 'Nomsa Dlamini' : ''}
              />
            </div>
            <div className="form-group" style={{ marginBottom: 16 }}>
              ...
              <input
                ...
                defaultValue={isDemo ? '+27 82 555 0123' : ''}
              />
            </div>
        ...
        <div style={{ display: 'flex', gap: 16, alignItems: 'center', maxWidth: 700, margin: '0 auto' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.7)', marginTop: 2 }}>
              {isDemo ? '📍 Sandton, Johannesburg' : '📍 Location not set yet'}
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="screen-content">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
            {(isDemo
              ? [
                  { val: '8', l: 'Bookings' },
                  { val: '4.9', l: 'Avg Rating' },
                  { val: 'R3,850', l: 'Total Spent' },
                ]
              : [
                  { val: '0', l: 'Bookings' },
                  { val: '—', l: 'Avg Rating' },
                  { val: 'R0', l: 'Total Spent' },
                ]
            ).map((s, i) => (
              <div key={i} className="stat-card" style={{ textAlign: 'center' }}>
                <div className="stat-num" style={{ color: 'var(--teal)', textAlign: 'center' }}>
                  {s.val}
                </div>
          ...
          {[
            ...
            { label: 'Booking History', icon: '📋', nav: isDemo ? ('consumer-bookings' as const) : undefined },
            ...
            >
              ...
              <span
                style={{ flex: 1, fontFamily: 'var(--font-head)', fontWeight: 700, fontSize: 15 }}
