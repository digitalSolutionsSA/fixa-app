...
import { Shield, ChevronRight, AlertTriangle, Wrench, Zap, Car, MoreHorizontal } from 'lucide-react';
import { useApp } from '../../contexts/AppContext';
import { AppHeader, ConsumerNav, RatingStars, Avt, NotifBell } from '../../components/Shared';
            ...
            <div className="section-row">
              ...
              {isDemo && (
                <button
                  ...
                  style={{ fontFamily: 'var(--font-head)', fontWeight: 700, fontSize: 13, color: 'var(--teal)', background: 'none', border: 'none', cursor: 'pointer' }}
                >
                  View all
                </button>
              )}
            ...
            {isDemo ? (
              PROVIDERS.slice(0, 2).map((p, i) => (
                <button
                  ...
                  onClick={() => { selectProvider(p); navigate('find-provider'); }}
                >
              ...
              <div className="card" style={{ textAlign: 'center', padding: '20px 16px' }}>
                <div style={{ fontFamily: 'var(--font-head)', fontWeight: 800, fontSize: 15 }}>No providers shown yet</div>
                <div style={{ fontSize: 13, color: 'var(--text-secondary)', marginTop: 6, lineHeight: 1.5 }}>
